module Admin
  class PortfoliosController < Admin::ApplicationController
    ...
    def update
      ...
      super
      @requested_resource&.update(slug: nil)
    end

    private

    def handle_photo_upload
      uploaded_file = params[:portfolio][:photo]
      
      # Create a temporary file
      temp_file = Tempfile.new(['portfolio_photo', File.extname(uploaded_file.original_filename)])
      temp_file.binmode
      ...
      begin
        ...
        # Update the portfolio with the URLs
